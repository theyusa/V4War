...
class RuleItem(val type: String = "", val content: String) {
    companion object {
        ...
        const val TYPE_FLAG_NAME = "name"
        const val TYPE_FLAG_PATH = "path"
        const val TYPE_USER = "user"
        const val TYPE_USER_ID = "uid"

        private fun validType(type: String) = when (type) {
            "",
            TYPE_FLAG_RULE_SET, TYPE_FLAG_FULL,
            TYPE_FLAG_DOMAIN_SUFFIX, TYPE_FLAG_REGEX,
            TYPE_FLAG_NAME, TYPE_FLAG_PATH,
