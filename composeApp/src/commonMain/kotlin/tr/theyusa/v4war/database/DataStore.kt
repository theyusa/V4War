...
import tr.theyusa.v4war.SPEED_TEST_UPLOAD_URL
import tr.theyusa.v4war.SPEED_TEST_URL
...
import tr.theyusa.v4war.database.preference.DataStorePreferenceDataStore
import tr.theyusa.v4war.database.preference.createConfigurationDataStore
import tr.theyusa.v4war.ktx.boolean
import tr.theyusa.v4war.ktx.int
import tr.theyusa.v4war.ktx.long
import tr.theyusa.v4war.ktx.parsePort
import tr.theyusa.v4war.ktx.string
import tr.theyusa.v4war.ktx.stringSet
...
object DataStore {
    ...
    val effectiveSpeedInterval: Int
        get() = if (screenOff) (speedInterval.coerceAtLeast(1000) * batteryThrottleFactor).coerceAtMost(30000) else speedInterval
    ...
    var batteryThrottleFactor by configurationStore.int(Key.BATTERY_THROTTLE_FACTOR) { 5 }
