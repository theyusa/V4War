...
object Key {
    ...
    const val CONNECTION_TEST_IGNORE_HANDSHAKE_TIME = "connectionTestIgnoreHandshakeTime"
...
object Action {
    const val SERVICE = "tr.theyusa.v4war.SERVICE"
    const val CLOSE = "tr.theyusa.v4war.CLOSE"
    const val RELOAD = "tr.theyusa.v4war.RELOAD"

    // const val SWITCH_WAKE_LOCK = "tr.theyusa.v4war.SWITCH_WAKELOCK"
    const val RESET_UPSTREAM_CONNECTIONS = "tr.theyusa.v4war.RESET_UPSTREAM_CONNECTIONS"
}
