...
import tr.theyusa.v4war.Action
import tr.theyusa.v4war.AlertType
import tr.theyusa.v4war.aidl.IServiceControlStub
import tr.theyusa.v4war.aidl.IServiceObserver
import tr.theyusa.v4war.aidl.SpeedDisplayData
import tr.theyusa.v4war.bg.proto.ProxyInstance
...
import tr.theyusa.v4war.ktx.broadcastReceiver
import tr.theyusa.v4war.ktx.hasPermission
...
import tr.theyusa.v4war.aidl.ServiceStatus as AidlServiceStatus
        ...
        fun changeState(s: ServiceState, message: String? = null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                TileService.requestListeningState(
                    context,
                    ComponentName(context, tr.theyusa.v4war.bg.TileService::class.java),
                )
            }
        }
